...
"add1" is a function that was created by passing 1 to add’s curry method. 
The "add1" function adds 1 to its argument.
...
of the arguments from the invocation of curry and the current invocation. 
It uses the "Array concat" method to concatenate the two arrays of arguments together.

Unfortunately, as we saw earlier, the arguments array is not an array, so it does not have the concat method. 
To work around that, we will apply the array slice method on both of the "arguments" arrays. 
